        ...
        <header class="navbar-section">
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" style="margin-top: 0;">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a href="user_profile.php"><img src="../includes/images/profile-user.png"
                                        alt="profile-user" style="height:43px; width:43px;"></a>
                            </li>
                            <!-- <li class="nav-item"> -->
