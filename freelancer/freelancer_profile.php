...
if (isset($_SESSION['email'])) {
    ...
    $query = "SELECT username,contactno,email FROM freelancer_signup WHERE email = ?";
...
$query2 = "SELECT * FROM accepted_projects WHERE free_email = ?";
...
<html lang="en">
    ...
    <body>
        <?php include 'freelancer_header.php' ?>
