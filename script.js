...
const getResponse = async (incomingMessage) => {
    ...
    if (userData.message.toLowerCase().includes("when you are created")) {
        message_div.innerText = "I was created on 9 February 2025 by Dhairya Makwana! ";
        if (thinkingDots) thinkingDots.remove();
        return;
    }
...
const handleUserMessage = (e) => {
    ...
    const userMessageContent = `${userData.file.data ? `<img src = "data:${userData.file.mime_type};base64,${userData.file.data}" class="attachfile"/>` : ""}
    ...
    setTimeout(() => {
        ...
        const botMessageContent = `
            <div class="message">
                <img src="https://static.vecteezy.com/system/resources/previews/019/786/706/original/chatbot-icon-cute-smiling-robot-cartoon-character-illustration-png.png">
...
document.querySelector("#file-upload").addEventListener("click",()=>{filebtn.click()});

const pop = document.querySelector("#popbtn");
const chatbot = document.querySelector(".main");
