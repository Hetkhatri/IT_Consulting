    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                ...
                <button class="btn"><a class="nav-link" href="#projects">Estimate Project</a></button>
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12">
                <img src="./includes/images/hero-image.png" alt="" class="img-fluid">
            </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 services">
                ...
                <div class="row row1">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            <img src="./includes/images/research.png" class="card-img-top" alt="...">
                            <div class="card-body">
                ...
                <div class="row row2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            <img src="./includes/images/ux.png" class="card-img-top" alt="...">
                            <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <img src="includes/images/about.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 text-content">
                <h3>who we are</h3>
    ...
    <div class="container">
        ...
        <div class="row project">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <img src="includes/images/project1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <img src="includes/images/project2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <img src="includes/images/project3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="text">
                            <h4 class="card-title">Travel Website</h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <img src="includes/images/project4.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="text">
                            <h4 class="card-title">SaaS Website</h4>
            ...
            <div class="col-lg-6 form">
                <form action="contact.php" method="POST" class="php-email-form">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="subject" placeholder="projects name" required>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-12 col-sm-12">
                <p class="logo"><i class="bi bi-chat"></i> Twinder Spot</p>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
                <ul class="d-flex">
                    <li><a href="#">Home</a></li>
