...
<body class="flex">
    ...
    <div class="introduction">
        ...
        <input type="text" placeholder="Project Title" name="titl" required>
        <input type="text" placeholder="Purpose" name="purpo" required>
    ...
    <div class="submit">
        <button type="submit" name="btn">Submit</button> <!-- Added name="btn" -->
    </div>
</form>
